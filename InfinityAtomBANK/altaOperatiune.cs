...
{
    public partial class altaOperatiune : Form
    {
        public static altaOperatiune instance;
        public altaOperatiune()
        {
            InitializeComponent();
            instance = this;
            string lunaInText = "";
        ...
        private void altaOperatiune_Load(object sender, EventArgs e)
        {
